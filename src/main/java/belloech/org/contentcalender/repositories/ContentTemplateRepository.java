...
public class ContentTemplateRepository {
    ...
    public List<Content> getAllContent() {
        ...
        List<Content> contents = jdbcTemplate.query(sql, ContentTemplateRepository::mapRow);
        return contents;
    }
    ...
    public Content getContent(int id) {
        ...
        Content content = jdbcTemplate.queryForObject(sql, new Object[]{id}, ContentTemplateRepository::mapRow);
        return content;
    }
}
